(function (global, factory) {
    ...
    async function parseRequest(req) {
        ...
        const body = req.body;  //to resolve firebase problem
    ...
    return server   // instead of the next lines, in order to work in firebase. Otherwise - for local server (as originaly created)
    // const server = http__default['default'].createServer(requestHandler(plugins, services));
